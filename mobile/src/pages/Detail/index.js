...
export default function Detail() {
    ...
    function sendMail(incident, body) {
    ...
    function sendWhatsapp(incident, message) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contactBox}>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity style={styles.action} onPress={() => sendWhatsapp(incident, message)}>
                        <Text style={styles.actionText}>WhatsApp</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.action} onPress={() => { }}>
                        <Text style={styles.actionText} onPress={() => sendMail(incident, message)}>E-mail</Text>
                    </TouchableOpacity>
                </View>
            </View>
